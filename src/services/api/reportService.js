 ...
 */
export function getReportsUsage(params) {
  return request('getReportsUsage', params);
}

/**
 * 보고서 사용 1회 기록 — 갱신된 top 목록을 돌려줍니다
 * @param {{screenId:string}} params
 * @returns {Promise<object>} items[{screenId,useCount,lastUsedAt}]
 */
export function postReportsUsage(params) {
  return request('postReportsUsage', params);
}
