...
export const AGENT_DEFS = [
  ...
  { no: '④', name: '원인 분석', role: '공정조건·금형 기여도 분석', screens: 'qc-aoi, qc-report' },
  { no: '⑤', name: '이력 추적', role: 'LOT 단계별 이력 추적', screens: 'ai-chat, qc-report' },
  { no: '⑥', name: '보고서 생성', role: '보고서 초안 자동 생성', screens: 'prod-daily, qc-report' },
  { no: '⑦', name: '보안 필터링', role: '고객사 정책별 마스킹', screens: 'qc-report, base-model' },
