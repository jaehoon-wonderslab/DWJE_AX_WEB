...
export const useCommonStyles = makeStyles((theme) => {
  ...
  return StyleSheet.create({
    ...
    card: {
      ...
      overflow: 'hidden',
      // shadcn Card 의 가벼운 떠오름을 웹·네이티브에서 같은 밀도로 표현합니다.
      shadowColor: '#0f172a',
      shadowOpacity: theme.isDark ? 0.18 : 0.055,
      shadowRadius: 8,
      shadowOffset: { width: 0, height: 2 },
      elevation: 2,
      ...Platform.select({ web: { boxShadow: theme.isDark ? '0 2px 8px rgba(0,0,0,.18)' : '0 2px 8px rgba(15,23,42,.055)' } }),
    },
    cardHead: {
      paddingVertical: 16,
    ...
    cardHeadTitle: { fontFamily: FONT_FAMILY, fontSize: 15, fontWeight: '600', letterSpacing: -0.2, color: color.foreground },
