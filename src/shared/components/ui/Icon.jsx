...
const PATHS = {
  ...
  help: [{ c: [12, 12, 9] }, 'M9.1 9.1a3 3 0 0 1 5.8 1c0 2-2.9 3-2.9 3', 'M12 17h.01'],
  ...
  triangle: ['m12 4 8.5 15h-17Z'],
  star: ['m12 3 2.8 5.9 6.4.9-4.6 4.5 1.1 6.4L12 17.7 6.3 20.7l1.1-6.4L2.8 9.8l6.4-.9Z'],
  starFilled: [{ f: 'm12 3 2.8 5.9 6.4.9-4.6 4.5 1.1 6.4L12 17.7 6.3 20.7l1.1-6.4L2.8 9.8l6.4-.9Z' }],
};

export default function Icon({ name, size = 16, color, strokeWidth = 1.6, style }) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
      {parts.map((p, i) => {
        ...
        if (p?.f) {
          // 채운 도형 (별표 활성 등)
          return <Path key={i} d={p.f} fill={stroke} stroke={stroke} strokeWidth={strokeWidth} strokeLinejoin="round" />;
        }
        if (p?.r) {
