...
export const PRESS_STATUS = {
  RUNNING: { label: '가동 중', color: '#16a34a', condition: '양호' },
  WARNING: { label: '주의', color: '#f97316', condition: '주의' },
  STOPPED: { label: '정지', color: '#dc2626', condition: '점검필요' },
  MAINTENANCE: { label: '점검 중', color: '#64748b', condition: '점검필요' },
  DUMMY: { label: '레이아웃 더미', color: '#94a3b8', condition: '—' },
};
