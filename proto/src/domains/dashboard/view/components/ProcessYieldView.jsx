    ...
    <View style={styles.container}>
      ...
      <View
        style={[
          styles.summaryBar,
          {
            backgroundColor: theme.alpha('foreground', 0.06),
              ...
              <View
                style={[
                  styles.diffBadge,
                  {
                    ...
                    borderColor: avgDiff >= 0 ? theme.color.success : theme.color.destructive,
                  },
                ]}
              >
      ...
      <View style={styles.processList}>
        {items.map((item, idx) => {
          ...
          const barColor = !hasYield ? theme.divider : isOk ? theme.color.success : isWarn ? theme.color.warning : theme.color.destructive;
            ...
            >
              ...
              <View style={styles.rowLeft}>
                <View style={styles.pNameRow}>
                  <View style={[styles.pIndexBadge, { backgroundColor: theme.alpha('foreground', 0.1) }]}>
                ...
                {qty > 0 && (
                  <Text style={[styles.qtySub, { color: theme.color.textDim }]}>
                    투입 {comma(qty)} · 양품 {okQty == null ? '—' : comma(okQty)} · 불량 <Text style={{ color: ngQty > 0 ? theme.color.destructive : undefined, fontWeight: '500' }}>{ngQty == null ? '—' : `${comma(ngQty)} EA`}</Text>
                  </Text>
                )}
              </View>
              ...
              <View style={styles.rowCenter}>
                <View style={[styles.gaugeTrack, { backgroundColor: theme.alpha('foreground', 0.1) }]}>
                  {/* 실적 게이지 바 */}
                  <View
                    style={[
                      styles.gaugeBar,
                    ...
                    <View
                      style={[
                        styles.diffPill,
                        {
                          ...
                          borderColor: diff >= 0 ? theme.color.success : theme.color.destructive,
                        },
                      ]}
                    >
